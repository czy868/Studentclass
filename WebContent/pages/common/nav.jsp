...
<c:if test="${sessionScope.user.identity  == 2}">
				<ul class="nav nav-list">
					...
					<li>
						...
						<ul class="submenu">
								<li>
									<a href="homeworklist.do?pageNum=1&pageSize=5&studentId=${sessionScope.studentId }&flag=-1&date=-1">
										<i class="icon-double-angle-right"></i>
										完成作业
									</a>
								</li>
								<li>
									<a href="filehomeworklist.do?pageNum=1&pageSize=5&studentId=${sessionScope.studentId }&flag=-1&date=-1">
										<i class="icon-double-angle-right"></i>
										上传作业
									</a>
								</li>
					...
					<li>
						<a href="selectCoursedata.do?pageNum=1&pageSize=5&studentId=${sessionScope.user.id }&flag=-1&date=-1">
							<i class="icon-text-width"></i>
							<span class="menu-text">下载资料</span>
						</a>
					</li>
					<li>
						<a href="selectCoursecomment.do?pageNum=1&pageSize=5&studentId=${sessionScope.user.id }&flag=-1&date=-1">
							<i class="icon-text-width"></i>
							<span class="menu-text">讨论区</span>
						</a>
					</li>
